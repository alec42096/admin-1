...
#   -d "right_script=412148" \
#   -d "server[parameters][PUBLIC_IP]=text:11.11.11.11" \
# "https://my.rightscale.com/api/acct/$ACCT/servers/207486001/run_script"

curl -v -b mySavedCookies -X POST -H 'X-API-VERSION:1.0' \
  -d "right_script=https://my.rightscale.com/api/acct/$ACCT/right_scripts/376003" \
"https://my.rightscale.com/api/acct/$ACCT/servers/660959001/run_script"
